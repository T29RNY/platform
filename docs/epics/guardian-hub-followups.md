...
| 9 | **Holiday Camps** — P9.1 (534) + P9.2 (535) + P9.3a (536) + P9.3b + **P9.4 desktop create UI (mig 537) DONE** → P9.5 app club-admin /hub create surface = LAST sub-phase. | 3 | 2 | **building** | **apply(×N)** + merge(×N) |
