...
| 9 | **Holiday Camps feature** — see the DESIGN block below. **P9.1 (mig 534) + P9.2 (mig 535) + P9.3a (mig 536 guardian reader+cohort filter) DONE, APPLIED-live** → P9.3b guardian Sessions render (frontend), then P9.4 desktop UI, P9.5 app create surface. | 3 | 2 | **building** | **apply(×N)** + merge(×N) |
