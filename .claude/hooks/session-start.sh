...
echo "  skills/casual-regression.md — MANDATORY for Phase 5+ cycles touching apps/inorout"
echo "  skills/ephemeral-verify.md — MANDATORY for any new write RPC"
...
echo "  check-hygiene.sh <file>    — 8 hygiene rules (auto on edit)"
