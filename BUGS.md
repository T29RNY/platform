...
## BUG (Jul 14 2026) — ✅ FIXED (PR #PENDING, no migration) — new Stripe member's FIRST invoice payment doesn't reconcile to the ledger in real time (parallel-webhook race)
