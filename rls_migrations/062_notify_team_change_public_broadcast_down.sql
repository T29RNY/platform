-- ════════════════════════════════════════════════════════════════════════════
-- 062 DOWN — restore notify_team_change to default-private broadcasts
-- ════════════════════════════════════════════════════════════════════════════
-- Reverts to pre-062 behaviour: realtime.send called with 3 args, private
-- defaults to true. Effectively breaks the App.jsx broadcast subscriber.
-- Safe to apply if rolling back.
-- ════════════════════════════════════════════════════════════════════════════
