-- 160_ref_fixture_state_lineup_aware_down.sql
-- Reverses 160: restores the mig-119 (non-lineup-aware) get_fixture_state_by_ref_token
-- and drops the internal _fixture_squad_json helper. Squads revert to the full active
-- player_registrations set with no lineup_role field.
...
DROP FUNCTION IF EXISTS public._fixture_squad_json(uuid, text, uuid);
