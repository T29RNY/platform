-- 573 DOWN: revert get_my_world() to the pre-573 body — the guardian arm WHERE
-- clause loses the `AND mg.invite_state = 'accepted'` condition, restoring the
-- exact live definition prior to migration 573. Every other arm is identical.
