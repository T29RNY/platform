-- 569 DOWN: restore club_manager_pitch_availability to the mig-568 busy shape (own-team
-- identity only; other same-club sessions + fixtures anonymised). Auth/grants unchanged.
