-- Down for migration 266 — restore the mig-247 get_display_state body (no clock_paused/added_time
-- on live_fixtures). Copied verbatim from 247_display_live_fixture_officials.sql.
