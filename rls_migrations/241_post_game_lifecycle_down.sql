-- 241 DOWN: restore the pre-session-80 bodies of set_player_status and
-- admin_save_match_result (no sign-up window gate; result-save does not close
-- the game, resets only attendees, and wipes the paid flag unconditionally).
