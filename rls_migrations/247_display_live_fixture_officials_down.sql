-- 247 DOWN: restore get_display_state to its mig-244 body — drops the
-- live_fixtures round_name / official_id / official_name keys and the
-- match_officials join inside live_fx. (Body below = mig 244 verbatim.)
