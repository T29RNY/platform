-- Down for 138 — restore the mig 109 venue_assign_pitch and mig 091
-- venue_generate_fixtures bodies (no exclusion_violation translation).
-- NOTE: without the translation, the fixture-mirror trigger (137) will
-- surface a raw 23P01 on a double-book. Roll back 137 too if you want the
-- pre-trigger behaviour.
