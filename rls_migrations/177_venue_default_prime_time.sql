...
ALTER TABLE venues
  ADD COLUMN IF NOT EXISTS default_prime_time_windows jsonb NOT NULL DEFAULT '[]'::jsonb;
...
-- ──────────────────────────────────────────────────────────────────
-- venue_get_state — expose default_prime_time_windows in the venue object
--   LIVE body (mig 176) reproduced verbatim + the one new venue key.
-- ──────────────────────────────────────────────────────────────────
