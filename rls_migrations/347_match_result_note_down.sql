-- ════════════════════════════════════════════════════════════════════════════
-- 347 DOWN — revert match result note
-- ════════════════════════════════════════════════════════════════════════════
-- Restores admin_save_match_result to its mig-268 14-arg form and the admin
-- state RPC to its mig-346 form (no result_note), then drops the column LAST.
-- ════════════════════════════════════════════════════════════════════════════

DROP FUNCTION IF EXISTS public.admin_save_match_result(text, text, text, integer, integer, text, integer, text[], text[], jsonb, text, text, text, jsonb, text);

-- ── restore admin_save_match_result 14-arg (mig 268) ─────────────────────────
...
GRANT EXECUTE ON FUNCTION public.admin_save_match_result(text, text, text, integer, integer, text, integer, text[], text[], jsonb, text, text, text, jsonb) TO anon, authenticated;

-- ── restore admin state RPC (mig 346, no result_note) ────────────────────────
...
ALTER TABLE public.matches DROP COLUMN IF EXISTS result_note;
