-- Down migration for 080 — reverts get_team_state_by_player_token to the
-- pre-080 limited-squad shape (VCs and admins lose group_number, payments,
-- stats, locks, and the caller is excluded from squad again).
