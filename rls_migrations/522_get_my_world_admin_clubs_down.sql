-- 522_get_my_world_admin_clubs_down.sql
-- Reverts mig 522: restores get_my_world to the mig-520 definition (venue arm with
-- origin/club_id, but NO admin_clubs arm). Verbatim mig 520 body.
