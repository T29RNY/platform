-- 520_get_my_world_club_admin_arm_down.sql
--
-- Reverts mig 520: restores get_my_world to the mig-494 definition (venue arm
-- with the original 4 keys — no origin/club_id). Verbatim mig 494 body.
