-- Down migration 349 — restore the pre-349 bodies of the two team-state RPCs
-- (remove team_type / is_competitive / club_id / club_name from the return shape).
-- These RPCs are load-bearing for the whole consumer app, so the down re-creates
-- the prior bodies rather than dropping the functions.

-- ─────────────────────────────────────────────────────────────────────────────
-- 1. get_team_state_by_player_token (pre-349)
-- ─────────────────────────────────────────────────────────────────────────────
...
-- ─────────────────────────────────────────────────────────────────────────────
-- 2. get_team_state_by_admin_token (pre-349)
-- ─────────────────────────────────────────────────────────────────────────────
