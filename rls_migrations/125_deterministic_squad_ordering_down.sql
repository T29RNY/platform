-- Restore mig 070 / mig 080 squad jsonb_agg without ORDER BY.
-- Restoring this re-introduces the non-deterministic squad ordering bug.
...
BEGIN
  ...
  -- (rest of body unchanged — only squad jsonb_agg differed between 125 and prior)
  -- Restoring full body for completeness:
