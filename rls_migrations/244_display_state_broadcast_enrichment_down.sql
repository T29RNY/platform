-- 244 DOWN: restore get_display_state to its mig-221 body (last-5 form, no
-- broadcast enrichment). Drops upcoming officials/round keys, the top-level
-- bookings[] array, and top_scorers apps/shirt_number.
