-- DOWN 216: restore the mig-209 guest-DELETING bodies (remove_guest_player +
-- both go-live RPCs). Does NOT re-run mig-209's one-off orphan sweep (that data
-- mutation already ran and is not part of the reversible function definition).

-- ── remove_guest_player (mig-209 deleting body) ─────────────────────────────
...
-- ── admin_go_live (mig-209 deleting body) ───────────────────────────────────
...
-- ── admin_go_live_for_team (mig-209 deleting body) ──────────────────────────
