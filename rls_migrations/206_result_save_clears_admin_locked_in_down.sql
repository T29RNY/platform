-- 206 DOWN: restore admin_save_match_result to the mig-205 body (fresh-save reset
-- does NOT clear admin_locked_in). Reinstates the stuck-lock gap; rollback only.
-- Body below is the mig-205 canonical function.
--
