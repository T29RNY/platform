-- Down migration for 079 — reverts to the mig 070 definition
-- (squad rows without group_number, settings without group_labels).
-- Restores the broken state. Only use if 079 caused regressions.
